...
const ObjectsPage = () => {
  ...
  // handleFileChange untuk menangani input gambar spesifik
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.images) {
      formData.images.forEach((image, index) => {
        if (image) {
          form.append(`images`, image); // backend tetap terima array images
        }
      });
    }
  ...
  {objects.map((object) => {
    // Parsing image_url menjadi array
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-lg w-96">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium">Image 5</label>
                  <input
                    type="file"
